...
public class NewGame {
	...
	public static void InitAllModels() {
		...
		allModels.Add("STOP",
		              HiddenMarkovModel<MultivariateNormalDistribution>.Load("GestureModels/STOP16.bin"));
		allModels.Add("LIFT_POINTER_FINGER",
		              HiddenMarkovModel<MultivariateNormalDistribution>.Load("GestureModels/LIFT_POINTER_FINGER14.bin"));
		allModels.Add("POINT_FINGERGUN",
		              HiddenMarkovModel<MultivariateNormalDistribution>.Load("GestureModels/POINT_FINGERGUN20.bin"));
		allModels.Add("OK_RING",
		              HiddenMarkovModel<MultivariateNormalDistribution>.Load("GestureModels/OK_RING18.bin"));
	...
	public static void InitCulturalLayer() {
		...
		culturalLayer.AddDefaultGesture("STOP", "STOP");
		culturalLayer.AddDefaultGesture("LIFT_POINTER_FINGER", "LIFT_POINTER_FINGER");
		culturalLayer.AddDefaultGesture("POINT_FINGERGUN", "POINT_FINGERGUN");
		culturalLayer.AddDefaultGesture("OK_RING", "OK_RING");
	...
	public static Actions PointAtState() {
		...
		state.AddAction("NOTHING");
		state.AddAction("POINT_FINGERGUN");
		return state;
	}
	...
	public static Actions PhoneState() {
		...
		state.AddAction("LIFT_POINTER_FINGER");
		return state;
	}
